...
document.getElementById('expand-button').addEventListener('click', function() {
    ...
    eventContent.style.maxHeight = 'none'; // Rimuovi limitazione altezza
    this.style.display = 'none'; // Nascondi il tasto "+"
    collapseButton.style.display = 'inline-block'; // Mostra il tasto "-"
});

// Funzione per richiudere il box degli eventi
document.getElementById('collapse-button').addEventListener('click', function() {
    const eventBox = document.getElementById('event-box');
    const eventContent = document.getElementById('event-content');
    const expandButton = document.getElementById('expand-button');

    eventBox.style.height = '150px';  // Riduci la height
    eventContent.style.maxHeight = '130px'; // Ripristina il limite di altezza
    this.style.display = 'none'; // Nascondi il tasto "-"
